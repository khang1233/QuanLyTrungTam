    ...
    public class NhanVienBUS
    {
        ...
        public bool InsertNhanSu(string hoTen, DateTime ngaySinh, string sdt, string email, string loaiNS, string chuyenNganh)
        {
            ...
            if (!UserSession.Instance.IsAdmin())
                throw new UnauthorizedAccessException("Chỉ Quản trị viên mới có quyền thêm nhân sự!");
        ...
        public bool UpdateNhanSu(string maNS, string hoTen, DateTime ngaySinh, string sdt, string email, string loaiNS, string chuyenNganh)
        {
             // Security Check
             if (!UserSession.Instance.IsAdmin())
                throw new UnauthorizedAccessException("Chỉ Quản trị viên mới có quyền cập nhật nhân sự!");
        ...
        public bool DeleteNhanVien(string ma)
        {
            // Security Check
            if (!UserSession.Instance.IsAdmin())
                throw new UnauthorizedAccessException("Chỉ Quản trị viên mới có quyền xóa nhân sự!");
