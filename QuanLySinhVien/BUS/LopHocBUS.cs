...
namespace QuanLyTrungTam.BUS
{
    public class LopHocBUS
    {
        ...
        {
            if (!UserSession.Instance.IsAdmin()) throw new UnauthorizedAccessException("Chỉ Quản trị viên được phép mở lớp mới!");
            if (LopHocDAO.Instance.CheckDuplicateName(tenLop, "")) throw new Exception("Tên lớp học đã tồn tại! Vui lòng chọn tên khác.");
        ...
        {
            if (!UserSession.Instance.IsAdmin()) throw new UnauthorizedAccessException("Chỉ Quản trị viên được phép cập nhật lớp!");
            if (LopHocDAO.Instance.CheckDuplicateName(tenLop, maLop)) throw new Exception("Tên lớp học đã tồn tại! Vui lòng chọn tên khác.");
        ...
        {
            if (!UserSession.Instance.IsAdmin()) throw new UnauthorizedAccessException("Chỉ Quản trị viên được phép xóa lớp!");
